...
export default function FailSendEmailDialog({ isOpen, onClose }: PropsType) {
  if (!isOpen) {
    return null;
  }
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 className="text-lg leading-6 font-bold text-red-500">
                  Emails Failed
                </h3>
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Something went wrong and the emails did not send!
                    <br />
                    Try again later.
                  </p>
                </div>
